...
class ClubJugador extends BaseClass {
	 ...
	 * @var
	 *
	 * @ORM\ManyToOne(targetEntity="AppBundle\Entity\Jugador", inversedBy="clubJugador", cascade={"persist","remove"})
	...
	/**
	 *
	 * @ORM\OneToMany(targetEntity="AppBundle\Entity\FichaMedica", mappedBy="clubJugador", cascade={"persist", "remove"})
	 */
	private $fichaMedica;
