...
use AppBundle\Entity\PagoJugador;
...
class PagoJugadorController extends Controller {
	...
	public function indexAction( Request $request ) {
		...
		$pagoJugadors = $em->getRepository( 'AppBundle:PagoJugador' )->findQbByClub( $club );
...
//		TODO opcion de pago anual
	...
	public function newAction( Request $request ) {
		...
		$form = $this->createForm( 'AppBundle\Form\PagoJugadorType',
			$pagoJugador,
			[
				'club' => $club
			] );
	...
	public function editAction( Request $request, PagoJugador $pagoJugador ) {
		$deleteForm = $this->createDeleteForm( $pagoJugador );
		$editForm   = $this->createForm( 'AppBundle\Form\PagoJugadorType', $pagoJugador );
