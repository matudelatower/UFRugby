    ...
    <div class="row">
      ...
      <div class="col-md-4">
        <div class="form-group" v-bind:class="{ 'has-error': $v.sexo.$error }"><label
            class="control-label required" for="appbundle_precompetitivo_sexo">Género
          *</label>
      ...
      <div class="col-md-4">
        <div class="form-group" v-bind:class="{ 'has-error': $v.fechaNacimiento.$error }"><label
          ...
          <span class="help-block"
                v-if="$v.fechaNacimiento.$error && !$v.fechaNacimiento.required">Campo Requerido</span>
        </div>
      </div>
    </div>
    <div class="row">
      ...
      <div class="col-md-6">
        <div class="form-group" v-bind:class="{ 'has-error': $v.direccion.$error }"><label
            class="control-label required"
            for="appbundle_precompetitivo_contacto_direccion">Adjuntar Identificacion</label>
          <input @change="processFile($event)"
                 :disabled="disableFields"
                 id="appbundle_precompetitivo_identificacion"
                 name="appbundle_precompetitivo[identificacion]" required="required"
        ...
        <div class="col-md-4">
          <div class="form-group" v-bind:class="{ 'has-error': $v.posicionHabitual.$error }"><label
            ...
            *</label>
            ...
            <span class="help-block"
                  v-if="$v.posicionHabitual.$error && !$v.posicionHabitual.required">Campo Requerido</span>
          </div>
        </div>
        <div class="col-md-4">
...
export default {
  ...
  methods: {
    ...
    processFile(event) {
      console.log('file identificacion ', event)
