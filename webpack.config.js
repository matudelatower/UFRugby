...
Encore
    ...
    .addEntry('vue', './assets/js/app.js')
    .addEntry('login', './assets/js/login.js')
    .addEntry('functions', './assets/js/functions.js')

    // .addStyleEntry('css/main', './assets/styles/main.scss')
    .addStyleEntry('css/adminlte', './assets/styles/adminlte.scss')
    // .addStyleEntry('css/charts', './assets/styles/charts.scss')
    // .addStyleEntry('css/app', './assets/styles/app.scss')
    .addStyleEntry('css/vue', './assets/styles/app.scss')
